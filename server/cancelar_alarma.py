...
# --- CORRECTED Button Addresses (Base 0) ---
...
# --- End Corrected Button Addresses ---
...
# --- Function to Pulse a coil (Simulate Button Press) ---
def pulse_coil(client, address, pulse_duration=PULSE_WIDTH):
    ...
    try:
        ...
        if result_off.isError():
            ...
            # Even if setting back to False fails, the initial press might have worked.
            # However, leaving the coil ON is usually bad, so report failure.
            return False
...
if __name__ == "__main__":
    ...
    target_button_address = CANCEL_ALARM_BUTTON_ADDRESS
    button_name = "CANCEL ALARM"
    ...
    try:
        ...
        if client:
            ...
            if success:
                ...
                print(f"[INFO] Observe the system/PLC for the expected action (alarm cancelled).")
            else:
